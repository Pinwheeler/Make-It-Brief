...
@interface CoreDataTableViewController : UITableViewController <NSFetchedResultsControllerDelegate, UINavigationBarDelegate,DataManager>

// The controller (this class fetches nothing if this is not set).
@property (strong, nonatomic) NSFetchedResultsController *fetchedResultsController;
@property NSManagedObject *currentObject; //The object currently selected by the TableView
@property (nonatomic,weak) NSManagedObjectContext* sharedContext;
@property (strong, nonatomic) NSString* nameOfManagedEntity; //The name of the entity type that the the TableView is managing

- (void) setupFetchRequestWithSharedDocumentForEntityName:(NSString*)entityName descriptor:(NSString*)descriptor;
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath;
- (void) saveData;

- (IBAction)addObject:(id)sender; //Add/delete object of the preset type
